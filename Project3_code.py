...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\Users\HP\Desktop\New project phyton")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"G SENTHIL KUMAR"}')
    mail = (f'{"Mail :"}  {"gsk2805@gmail.com"}')
    Batch = (f'{"Batch Code :"}  {"MDTE08"}')
    description =(f'{"Description  :"}  {"An Aspiring DATA-SCIENTIST..!"}')
    social_media = {

        "GITHUB": "https://github.com/gsk2805/Airbnb-Analysis",
        "LINKEDIN": "https://www.linkedin.com/feed/update/urn:li:activity:7238240388363206658/"
        
        }

    col1, col2 = st.columns(2)
    col1.image(Image.open("C:/Users/HP/Desktop/New project phyton/MY PHOTO.png"), width=450)
